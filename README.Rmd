...
md_txt = function(i) {
    ...
    # md text
    paste0(
      '| ', cty_cdc$state_abb, ' | ', cty_cdc$county, ' | ', 
      '[![', tolower(i), ' cdc community badge](https://img.shields.io/badge/COVID--19%20Community%20Level-', cty_cdc$covid.19_community_level, '-', cty_cdc$community_level, '.svg)](https://www.cdc.gov/coronavirus/2019-ncov/science/community-levels.html) (updated on ', cty_cdc$date_community,') | ',

...
bristol_plt = ggplot(data = ma_week %>% dplyr::filter(county == 'Bristol'), aes(x = cases, y = week_sum, group = county)) + 
  geom_line() + 
...
# save plot
png(file = './images/bristol_county_covid.png',  width = 735, height = 526)
  print(bristol_plt)
dev.off()